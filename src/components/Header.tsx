    ...
    <header className="sticky top-0 z-50 bg-zinc-950 border-b border-zinc-800 shadow-xl">
      <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <a
          ...
          className="shrink-0 bg-red-600 hover:bg-red-500 active:bg-red-700 text-white text-xs font-bold uppercase tracking-widest px-3 py-2 rounded transition-colors"
